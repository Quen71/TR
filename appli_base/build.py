...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application my_cpu
#--- automatically generated by goil on Tue Feb  1 11:22:07 2022
...
sys.path.append("/Users/quentinlebreton/git/trampoline//make")
...
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex"]
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex/CMSIS/Include"]
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex/armv7em"]
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex/armv7em/stm32f407"]
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex/armv7em/stm32f407/lib"]
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex/armv7em/stm32f407/CMSIS-ST/Device/ST/STM32F4xx/Include"]
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver"]
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex/armv7em/stm32f407/STM32F4xx_StdPeriph_Driver"]
includeDirs += ["-I","/Users/quentinlebreton/git/trampoline//machines/cortex/armv7em/stm32f407/stm32f4discovery"]
if with_ioc:
  includeDirs += ["-I", "/Users/quentinlebreton/git/trampoline//ioc"]
includeDirs += ["-I", "/Users/quentinlebreton/git/trampoline//os"]
includeDirs += ["-I", "/Users/quentinlebreton/git/trampoline//debug"]
includeDirs += ["-I", "appli_base"]
cflags   += includeDirs
...
ldflags += "-Map=appli_base.map".split()
ldflags += ["-T", "appli_base/script.ld"]
asflags += "-g".split()
asflags += "-Wall".split()
...
#--- OIL file
oilSourceList.append("appli_base.oil")
...
cSourceList.append(projfile.ProjectFile("appli_base.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("appli_base/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("appli_base/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("appli_base/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("appli_base/tpl_primary_irq.S"))
cSourceList.append(projfile.ProjectFile("appli_base/tpl_vectors.c"))
cSourceList.append(projfile.ProjectFile("appli_base/tpl_external_interrupts.c"))
cSourceList.append(projfile.ProjectFile("appli_base/tpl_app_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary appli_base_exe.bin from appli_base_exe")
  postCommand.mCommand.append(r"arm-none-eabi-objcopy")
  postCommand.mCommand += "-O binary".split()
  postCommand.mCommand.append("appli_base_exe")
  postCommand.mCommand.append("appli_base_exe.bin")
...
postVariableMapping = dict(
  MACHINE_PATH='/Users/quentinlebreton/git/trampoline//machines',
  ARCH_PATH='/Users/quentinlebreton/git/trampoline//machines/cortex',
  BOARD_PATH='/Users/quentinlebreton/git/trampoline//machines/cortex/armv7em/stm32f407/stm32f4discovery',
...
if make.errorCount() == 0:
  if askedGoal == "burn" :
    ...
    commandLine += "appli_base_exe.bin "
    ...
    if makefile.find_executable("st-flash") != None:
      print("\033[1m\033[95mFlashing appli_base_exe on cortex/armv7em/stm32f407/stm32f4discovery\033[0m")
