...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application my_cpu
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file appli_base.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=cortex/armv7em/stm32f407/stm32f4discovery --templates=/Users/quentinlebreton/git/trampoline/goil/templates appli_base.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "appli_base.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=cortex/armv7em/stm32f407/stm32f4discovery", "--templates=/Users/quentinlebreton/git/trampoline/goil/templates"]
...
#--- Add generated files
sourceList.append("appli_base/tpl_app_config.c")

sourceList.append("appli_base/tpl_dispatch_table.c")
sourceList.append("appli_base/tpl_invoque.S")
sourceList.append("appli_base/tpl_primary_irq.S")
sourceList.append("appli_base/tpl_vectors.c")
sourceList.append("appli_base/tpl_external_interrupts.c")
sourceList.append("appli_base/tpl_app_interrupts.c")
